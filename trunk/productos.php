			...
			<div class="evento">
				...
				while ( $row = mysqli_fetch_array ( $consulta, MYSQLI_ASSOC ) ) {
					...
					while ( $row2 = mysqli_fetch_array ( $consulta2, MYSQLI_ASSOC ) ) {
						...
						echo '<img onclick="javascript:this.width=450;this.height=338" ondblclick="javascript:this.width=100;this.height=80"  src="css/img/producto/'. $row2 ['imagen'] .'" width="100"/>';
