	...
	<div id="contenido">
		<div id="cabecera">
			<img src="css/img/BannerVerde.jpg" id="fondoCabecera">
				<div id="titleHeader">
					<img src="css/img/rana-coloreada.gif" id="logo" width="140px"
						height="90px">
						<h1>Los Raneros</h1>
						<h3>Cafe Bar</h3>
		...
		<div id="contenedorCuerpo">
			<div class="evento">
				...
				if (isset ( $_SESSION ['esRoot'] ) && $_SESSION ['esRoot'] == 1) {
					...
					echo " <a href='modificarEvento.php?idEvento=" . $row2 ['idEvento'] . "'><img src='css/img/iconos/edit.png' class='icon' alt='Modificar Evento'> </a><a href='eliminarEvento.php?idEvento=" . $row2 ['idEvento'] . "'><img src='css/img/iconos/delete.png' class='icon' alt='Eliminar Evento'> </a></a>";
					echo "</div>";
					echo "</a>";
				} else {
					echo "</div>";
