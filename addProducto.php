...
<body>
	<div id="contenido">
		...
		<div id="contenedorCuerpo">
			...
			?>
			<div class="evento">
				<form action="confAddProducto.php" class="formularios" method="post" enctype="multipart/form-data">
					<div><label>Nombre nuevo producto</br></label><input type="text" name="nombre" id="nombre"></div>
