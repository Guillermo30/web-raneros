...
<body>
	<div id="contenido">
		...
		<div id="contenedorCuerpo">
			...
			?>
			<div class="evento">
				<form action="confModificarEvento.php" class="formularios" method="post" enctype="multipart/form-data">
					...
					<div><label>Fecha de Evento</br></label><input type="date" name="fecha" min="2015-01-01" max="2020-12-31" value="<?php echo $_GET ['fecha'] ?>"></div>
					...
					<div><input type="submit" value="Modificar Evento"></input><input type="reset" value="Reset"></div>
